...
describe('CoingeckoService', () => {
  ...
  it('should return all Basin tickers in the expected format', async () => {
    ...
    const wellVolumeResponse = JSON.parse('{"wells":[{"tokens":[{"id":"0xbea0000029ad1c77d3d5d23ba2d8893db9d1efab","decimals":6,"lastPriceUSD":"0.961579"},{"id":"0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2","decimals":18,"lastPriceUSD":"3809.019202375386134509816908503638"}],"rollingDailyTradeVolumeUSD":"26385.68890075838949285097406793472"}]}');
